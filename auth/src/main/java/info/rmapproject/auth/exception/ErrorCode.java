...
public enum ErrorCode {		
	...
	ER_COULD_NOT_CREATE_ID_FOR_AGENT (4019011),
	ER_RMAP_AUTHID_PREFIX_CANNOT_BE_EMPTY (4019012),
	ER_RMAP_AUTHID_PREFIX_MUST_PRODUCE_URI (4019013),
	ER_RMAP_BASEURL_CANNOT_BE_EMPTY (4019014),
	ER_RMAP_BASEURL_NO_TRAILING_SLASH (4019015),
	ER_RMAP_BASEURL_MUST_BE_URL(4019016),
	ER_USER_RECORD_NOT_FOUND(4019017),
	ER_APIKEY_RECORD_NOT_FOUND(4019018),
	ER_ADMIN_AGENT_URI_INVALID(4019019);
