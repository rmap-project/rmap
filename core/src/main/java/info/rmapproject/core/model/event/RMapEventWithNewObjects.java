...
public interface RMapEventWithNewObjects extends RMapEvent {
	...
	/**
	 * Gets a set of IRIs of the objects that were created for this event
	 *
	 * @return set of IRIs of the objects that were created
	 ...
	 *
	 * @param createdObjects set of IRIs of the objects that were created
	 * @throws RMapException the RMap exception
	 * @throws RMapDefectiveArgumentException the RMap defective argument exception
	 */
	public void setCreatedObjectIds(Set<RMapIri> createdObjects) throws RMapException, RMapDefectiveArgumentException;
